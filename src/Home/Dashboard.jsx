  ...
  return (
    <>
        <div className='duration-500 justify-center mx-auto'>
            <video 
                class="w-full object-cover justify-center mx-auto min-h-screen opacity-50" 
            ...
            <div className='md:px-10 mx-auto justify-center px-5'>
                <div className='text-white top-1/4 absolute md:left-0 md:right-0 justify-center pt-10 md:pt-0 md:text-center md:mx-auto'>
                    <div className='md:text-center mx-auto max-w-screen-lg'>
                        <h1 className='second duration-500 text-[#fff] pt-16 uppercase  text-2xl font-displace'>
                            Welcome to <br /> <span className='text-[#ffffff] md:text-8xl text-4xl tracking-wider font-displace'>SCS MENA</span><span className='text-[#201F52] md:text-8xl font-normal text-4xl tracking-wider'></span>
                        </h1>                    </div>
                    <div className='third md:pt-5 pt-3 md:pb-0 md:text-2xl text-base tracking-wider max-w-screen-md justify-center md:text-center mx-auto duration-500'>
                        <p className='md:font-light text-[#ffffff]'> 
