...
function Post() {
  ...
  return (
    <div className='mx-auto px-5 items-center md:py-20 bg-[#fff]'>
      <div className='max-w-screen-xl mx-auto text-[#000] border-t-8 border-[#59A93D] py-16 border-opacity-25'>
        <div className='pt-20 mx-auto justify-center text-center'>
          <h3 className="text-[#59A93D] mb-2 font-displace text-2xl">
            Services
          </h3>
...
//         <Slider {...settings} className='flex mx-auto items-center gap-5 pt-5 text-[#000]'>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full md:my-7 w-48 hover:scale-105 mt-6 hover:px-4 items-center text-[#000] font-light scroll-smooth duration-500 bg-[#59A93D] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full w-48 mt-2 hover:scale-105 hover:px-4 items-center text-[#000] font-light scroll-smooth duration-500 bg-[#59A93D] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full md:my-5 w-48 hover:scale-105 mt-5 hover:px-4 items-center text-[#000] font-light scroll-smooth duration-500 bg-[#59A93D] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full w-48 hover:scale-105 hover:px-4 items-center text-[#000] font-light scroll-smooth duration-500 bg-[#59A93D] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
