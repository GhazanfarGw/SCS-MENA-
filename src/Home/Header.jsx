...
function Logo({ isScrolled }) {
  ...
  return (
    <>
      {isScrolled ? (
            <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#fff] md:py-4 border-b border-[#A01F1A] border-opacity-30">
                ...
                <div className="flex items-center">
                  <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
                    ...
                    <ul className="md:flex hidden items-center w-full justify-end mx-auto">
                      <li>
                        <Link to="/" className="items-center text-sm font-semibold tracking-wider relative h-8 pt-0.5 duration-200 px-4 flex justify-center flex-row hover:text-[#A01F1A] text-black">
                          Home
                        </Link>
                      </li>
                      <NavLinks />
                      <li>
                        <Link to="/careers" className="items-center text-sm font-semibold tracking-wider relative h-8 pt-0.5 duration-200 pr-16 flex justify-center flex-row hover:text-[#A01F1A] text-black">
                          Careers
                        </Link>
                      </li>
                      <div className='flex'>
                        <a 
                          href="mailto:umair@scsmena.com" className="hover:px-4 items-center text-[#ffffff] font-semibold text-sm text-center mx-auto scroll-smooth duration-500 bg-[#A01F1A] relative h-10 tracking-wide w-40 md:px-4 justify-center flex rounded-sm">
                          Contact Us
                        </a>
                        <div>
                  </div>
              ...
              >
                ...
                <li> 
                  <Link to="mailto:umair@scsmena.com" className="bg-[#A01F1A] text-white items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
                    Contact Us
                  </Link>
                </li>
              </ul>
        ...
        <div className="flex items-center">
          <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
            ...
            <ul className="md:flex hidden items-center w-full justify-end mx-auto">
              ...
              <div className='flex'>
                <a 
                  href="mailto:umair@scsmena.com" className="hover:px-4 items-center text-[#A01F1A] font-semibold text-sm mx-auto scroll-smooth duration-500 bg-[#fff] relative h-10 tracking-wide w-40 md:px-4 justify-center flex rounded-sm">
                  Contact Us
                </a>
              </div>
            </ul>
...
//           </div>
        //   <ul className="md:flex hidden items-center w-full justify-end mx-auto">
        //     <li>
        //       <Link to="/" className="items-center text-sm font-semibold tracking-wider relative h-8 pt-0.5 duration-200 px-4 flex justify-center flex-row hover:text-[#A01F1A]">
        //         Home
        //       </Link>
        //     </li>
        //     <NavLinks />
        //     <li>
        //       <Link to="/careers" className="items-center text-sm font-semibold tracking-wider relative h-8 pt-0.5 duration-200 pr-16 flex justify-center flex-row hover:text-[#A01F1A]">
        //           Careers
        //         </Link>
        //       </li>
        //     <div className='flex'>
        //       <a 
        //         href="/contact" className=" bg-[#A01F1A] shadow-lg hover:bg-opacity-80 hover:font-bold text-black font-semibold items-center relative h-10 text-sm duration-200 px-10 flex rounded-sm ">
        //         Contact Us
        //       </a>
        //     </div>
        //   </ul>
        ...
        //   >
        //     <li>
        //       <Link to="/" className="tracking-wider hover:bg-[#1a1e24] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#A01F1A] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
        //         Home
        //       </Link>
        //     </li>
        //     <NavLinks/>
        //     <li>
        //       <Link to="/careers" className="tracking-wider hover:bg-[#1a1e24] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#A01F1A] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
        //         Careers
        //       </Link>
        //     </li>
        //     <li>
        ...
        //         className="tracking-widest py-3 px-8 flex hover:text-[#A01F1A] flex-row duration-200 justify-between items-center border-b border-[#000] border-opacity-10 font-bold text-sm" 
        ...
        //       </p>
        //     <li>
        //       <Link to="/contact" className="hover:bg-[#A01F1A] border border-[#A01F1A] items-center relative h-10 mt-8 tracking-wider duration-200 mx-10 justify-center flex rounded-sm">
        //         Contact us
        //       </Link>
        //     </li>
        //   </ul>
