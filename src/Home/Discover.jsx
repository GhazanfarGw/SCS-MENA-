...
const Discover = () => {
    ...
    return (
        <>
            <div data-aos="zoom-in-up" data-aos-delay="300" data-aos-duration="400" className='items-center overflow-hidden md:mx-auto mx-5 bg-opacity-80 max-w-screen-xl bg-white'>
